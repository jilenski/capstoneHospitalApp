...
<br>
  ...
  <div class="form-group">
    <label for="">Significant Medical History (surgery, injuries, serious illness):</label>
    <input type="text" class="form-control" id="" placeholder="">
  </div>
  <div class="form-group">
    <label for="">List any Medical Problems (asthma, seizures, headaches):</label>
    <input type="text" class="form-control" id="" placeholder="">
  </div>
  <div class="form-group">
    <label for="">List any medication taken regularly:</label>
    <input type="text" class="form-control" id="" placeholder="">
  </div>
  <div class="form-group">
    <label for="">List any allergies:</label>
    <input type="text" class="form-control" id="" placeholder="">
  </div>
